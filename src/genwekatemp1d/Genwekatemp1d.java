  ...
  Connection conexion = null;
        try {
            ...
            ResultSet rs = s.executeQuery("select from_unixtime(dateTime) as fecha,date_format(from_unixtime(dateTime),'%k')+(date_format(from_unixtime(dateTime),'%i'))/60 as hora,round(((outTemp-32)/1.8),2) as temp, outHumidity as humedad, round((windSpeed/0.62137),2) as viento, rain as lluvia, uv as uv_actual,"+
                ...
                "where from_unixtime(dateTime)=DATE_ADD(fecha,INTERVAL 1 day) "+
                ...
                FileWriter miArchivo = null;
                 PrintWriter escribirArchivo;
                    ...
                    try
                    {
                        //miArchivo = new FileWriter("d:\\arffs\\climandtemp24h.arff");
                        miArchivo = new FileWriter("/home/hv/public_html/climandtemp24h.arff");
                        ...
                        escribirArchivo.println("@relation climandtemp24h");
                ...
                //System.out.println(rs.getString("fecha") + " " + rs.getString("hora")+" "+rs.getString("temp")+" "+rs.getString("humedad")+" "+rs.getString("viento")+" "+rs.getString("uv"));
                 ...
                 //PrintWriter escribirArchivo;
                    ...
                    try
                    {
                        ...
                        //miArchivo = new FileWriter("d:\\arffs\\climandtemp24h.arff",true);
                        miArchivo = new FileWriter("/home/hv/public_html/climandtemp24h.arff",true);
                        escribirArchivo = new PrintWriter(miArchivo);
                        //escribirArchivo.println("\""+rs.getString("fecha")+"\""+","+rs.getString("mes")+","+rs.getString("d_anio")+","+rs.getString("hormin")+"," +rs.getString("hora")+","+rs.getString("minuto")+","+rs.getString("temp")+","+rs.getString("humedad")+","+rs.getString("viento")+","+rs.getString("lluvia")+","+rs.getString("uv")+","+rs.getString("UV_M_1D")+","+rs.getString("UV_M_1H"));
...
////////////////comienza interaccion con weka    
                        try{
                            //clsModelo modelo = new clsModelo("d:\\arffs\\climandtemp24h.arff");
                            clsModelo modelo = new clsModelo("/home/hv/public_html/climandtemp24h.arff");
 
                            //modelo.generarModelo("d:\\arffs\\climandtemp24h.model");
                            modelo.generarModelo("/home/hv/public_html/climandtemp24h.model");
        ...
        try {
                ...
                FileWriter miArchivo = null;
                 PrintWriter escribirArchivo;
                    ...
                    try
                    {
                        //miArchivo = new FileWriter("d:\\arffs\\predicttemp1d.txt");
                        miArchivo = new FileWriter("/home/hv/public_html/predicttemp1d.txt");
                        escribirArchivo = new PrintWriter(miArchivo);
                        //escribirArchivo.println("\""+rs.getString("fecha")+"\""+","+rs.getString("mes")+","+rs.getString("d_anio")+","+rs.getString("hormin")+"," +rs.getString("hora")+","+rs.getString("minuto")+","+rs.getString("temp")+","+rs.getString("humedad")+","+rs.getString("viento")+","+rs.getString("lluvia")+","+rs.getString("uv")+","+rs.getString("UV_M_1D")+","+rs.getString("UV_M_1H"));
...
//                    PrintWriter escribirArchivo;
                    ...
                    try
                    {
                        ...
                        // miArchivo = new FileWriter("d:\\arffs\\predicttemp1d.txt",true);
                        miArchivo = new FileWriter("/home/hv/public_html/predicttemp1d.txt",true);
                        escribirArchivo = new PrintWriter(miArchivo);
                        System.out.println(rs.getString("uv_actual"));
                        ...
                        {
                        clsClasificacion clasificacion = new clsClasificacion("/home/hv/public_html/climandtemp24h.arff", "/home/hv/public_html/climandtemp24h.model");
                        //clsClasificacion clasificacion = new clsClasificacion("d:\\arffs\\climandtemp24h.arff", "d:\\arffs\\climandtemp24h.model");
